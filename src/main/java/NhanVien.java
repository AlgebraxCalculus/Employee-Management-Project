...
class NhanVien {
    ...
    private String MaNV, TenNV, GioiTinh, Email, SDT, NgaySinh, NgayBatDau;
...
//    private Luong luong;
    ...
    NhanVien(String TenNV, String GioiTinh, String Email, String SDT, String NgaySinh, String NgayBatDau) {
    ...
    public boolean checkD( String tmpD ) {
        ...
        if (!Pattern.matches(DATE_REGEX, tmpD))
            return false;
        int tmpNam = Integer.parseInt(tmpD.substring(tmpD.length() - 4));
        int tmpThang = Integer.parseInt(tmpD.substring(3, 5));
        int tmpNgay = Integer.parseInt(tmpD.substring(0, 2));
        return tmpThang < 13 && tmpThang > 0 && tmpNgay < 32 && tmpNgay > 0;
    }
...
//        return "Employee Code: " + MaNV + "\n" + "Employee Name: " + TenNV + "\n" +
//               "Gender: " + GioiTinh + "\n" +
//               "Email: " + Email + "\n" +
//               "Phone Number: " + SDT + "\n" +
//               "Date of Birth: " + NgaySinh + "\n" +
//               "Start Date: " + NgayBatDau + "\n" +
//               "Position: " + chucvu.getTen_ChucVu() + "\n" +  // In chức vụ
//               "Salary Information:\n" + luong;  // In thông tin lương
//    }
//    @Override
//    public String toString() {
